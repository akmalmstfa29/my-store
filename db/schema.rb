...
ActiveRecord::Schema.define(version: 2020_06_25_053632) do
  ...
  create_table "labels_products", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
